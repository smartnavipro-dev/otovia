...
import com.otovia.app.databinding.ActivityMainBinding
import com.otovia.app.ocr.QuotaManager
import java.util.*
import androidx.work.PeriodicWorkRequestBuilder
import androidx.work.ExistingPeriodicWorkPolicy
import androidx.work.WorkManager
import com.otovia.app.workers.QuotaResetWorker
import java.util.concurrent.TimeUnit
import com.otovia.app.privacy.PrivacyConsentDialog
...
class MainActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun updateQuotaDisplay() {
        runOnUiThread {
            ...
            // v1.1.52: ラベルはXML側に持つため値のみ表示、% 削除
            val newText = "${status.remaining} / ${status.limit}"
    ...
    companion object {
        private const val TAG = "Otovia_MainActivity"
    }
}